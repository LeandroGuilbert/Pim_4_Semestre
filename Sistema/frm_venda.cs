...
namespace Sistema
{
    public partial class frm_venda : Form
    {
        ...
        private void codigoPessoaLabel_Click(object sender, EventArgs e)
        {
        ...
        private void codigoVendaTextBox_TextChanged(object sender, EventArgs e)
        {
